<div id="referenceHeader"><?php echo $row_pref['menuCalculators']; ?></div>
<table>
  <tr>
    <td class="data_icon" width="1%"><img src="<?php echo $imageSrc; ?>calculator.png"></td>
    <td class="data" width="29%"><a href="calculate.php?section=bitterness" title="<?php echo $row_pref['menuCalculators']; ?>">Bitterness Calculator</a></td>
    <td class="data_icon" width="1%"><img src="<?php echo $imageSrc; ?>calculator.png" /></td>
