...
$style1 = mysqli_query($brewing,$query_style1);
$row_style1 = mysqli_fetch_assoc($style1);
...
for($i = 1; $i <= 15; ++$i) {
    ...
    $$extract = mysqli_query($brewing,$$query_extract);
    $$row_extract = mysqli_fetch_assoc($$extract);
    $$totalRows_extract = mysqli_num_rows($$extract);
}

mysqli_select_db($brewing,$database_brewing);

$query_extractPPG1 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_extract1['extractYield']);
$extractPPG1 = mysqli_query($brewing,$query_extractPPG1);
$row_extractPPG1 = mysqli_fetch_assoc($extractPPG1);

$query_extractPPG2 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_extract2['extractYield']);
$extractPPG2 = mysqli_query($brewing,$query_extractPPG2);
$row_extractPPG2 = mysqli_fetch_assoc($extractPPG2);

$query_extractPPG3 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_extract3['extractYield']);
$extractPPG3 = mysqli_query($brewing,$query_extractPPG3);
$row_extractPPG3 = mysqli_fetch_assoc($extractPPG3);

$query_extractPPG4 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_extract4['extractYield']);
$extractPPG4 = mysqli_query($brewing,$query_extractPPG4);
$row_extractPPG4 = mysqli_fetch_assoc($extractPPG4);

$query_extractPPG5 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_extract5['extractYield']);
$extractPPG5 = mysqli_query($brewing,$query_extractPPG5);
$row_extractPPG5 = mysqli_fetch_assoc($extractPPG5);
...
for($i = 1; $i <= 15; ++$i) {
    ...
    $$grain = mysqli_query($brewing,$$query_grain);
    $$row_grain = mysqli_fetch_assoc($$grain);
    $$totalRows_grain = mysqli_num_rows($$grain);
}

mysqli_select_db($brewing,$database_brewing);
$query_grainPPG1 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain1['maltYield']);
$grainPPG1 = mysqli_query($brewing,$query_grainPPG1);
$row_grainPPG1 = mysqli_fetch_assoc($grainPPG1);

$query_grainPPG2 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain2['maltYield']);
$grainPPG2 = mysqli_query($brewing,$query_grainPPG2);
$row_grainPPG2 = mysqli_fetch_assoc($grainPPG2);

$query_grainPPG3 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain3['maltYield']);
$grainPPG3 = mysqli_query($brewing,$query_grainPPG3);
$row_grainPPG3 = mysqli_fetch_assoc($grainPPG3);

$query_grainPPG4 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain4['maltYield']);
$grainPPG4 = mysqli_query($brewing,$query_grainPPG4);
$row_grainPPG4 = mysqli_fetch_assoc($grainPPG4);

$query_grainPPG5 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain5['maltYield']);
$grainPPG5 = mysqli_query($brewing,$query_grainPPG5);
$row_grainPPG5 = mysqli_fetch_assoc($grainPPG5);

$query_grainPPG6 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain6['maltYield']);
$grainPPG6 = mysqli_query($brewing,$query_grainPPG6);
$row_grainPPG6 = mysqli_fetch_assoc($grainPPG6);

$query_grainPPG7 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain7['maltYield']);
$grainPPG7 = mysqli_query($brewing,$query_grainPPG7);
$row_grainPPG7 = mysqli_fetch_assoc($grainPPG7);

$query_grainPPG8 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain8['maltYield']);
$grainPPG8 = mysqli_query($brewing,$query_grainPPG8);
$row_grainPPG8 = mysqli_fetch_assoc($grainPPG8);

$query_grainPPG9 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain9['maltYield']);
$grainPPG9 = mysqli_query($brewing,$query_grainPPG9);
$row_grainPPG9 = mysqli_fetch_assoc($grainPPG9);

$query_grainPPG10 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain10['maltYield']);
$grainPPG10 = mysqli_query($brewing,$query_grainPPG10);
$row_grainPPG10 = mysqli_fetch_assoc($grainPPG10);

$query_grainPPG11 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain11['maltYield']);
$grainPPG11 = mysqli_query($brewing,$query_grainPPG11);
$row_grainPPG11 = mysqli_fetch_assoc($grainPPG11);

$query_grainPPG12 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain12['maltYield']);
$grainPPG12 = mysqli_query($brewing,$query_grainPPG12);
$row_grainPPG12 = mysqli_fetch_assoc($grainPPG12);

$query_grainPPG13 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain13['maltYield']);
$grainPPG13 = mysqli_query($brewing,$query_grainPPG13);
$row_grainPPG13 = mysqli_fetch_assoc($grainPPG13);

$query_grainPPG14 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain14['maltYield']);
$grainPPG14 = mysqli_query($brewing,$query_grainPPG14);
$row_grainPPG14 = mysqli_fetch_assoc($grainPPG14);

$query_grainPPG15 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_grain15['maltYield']);
$grainPPG15 = mysqli_query($brewing,$query_grainPPG15);
$row_grainPPG15 = mysqli_fetch_assoc($grainPPG15);
...
$adjunct1 = mysqli_query($brewing,$query_adjunct1) or die(mysqli_error($brewing));
$row_adjunct1 = mysqli_fetch_assoc($adjunct1);

$query_adjunct1PPG = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_adjunct1['adjunctYield']);
$adjunct1PPG = mysqli_query($brewing,$query_adjunct1PPG) or die(mysqli_error($brewing));
$row_adjunct1PPG = mysqli_fetch_assoc($adjunct1PPG);

$query_adjunct2 = "SELECT adjunctYield, adjunctLovibond FROM adjuncts WHERE adjunctName='$brewAdjunct2'";
$adjunct2 = mysqli_query($brewing,$query_adjunct2) or die(mysqli_error($brewing));
$row_adjunct2 = mysqli_fetch_assoc($adjunct2);

$query_adjunct2PPG = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_adjunct2['adjunctYield']);
$adjunct2PPG = mysqli_query($brewing,$query_adjunct2PPG) or die(mysqli_error($brewing));
$row_adjunct2PPG = mysqli_fetch_assoc($adjunct2PPG);

$query_adjunct3 = "SELECT adjunctYield, adjunctLovibond FROM adjuncts WHERE adjunctName='$brewAdjunct3'";
$adjunct3 = mysqli_query($brewing,$query_adjunct3) or die(mysqli_error($brewing));
$row_adjunct3 = mysqli_fetch_assoc($adjunct3);

$query_adjunct3PPG = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_adjunct3['adjunctYield']);
$adjunct3PPG = mysqli_query($brewing,$query_adjunct3PPG) or die(mysqli_error($brewing));
$row_adjunct3PPG = mysqli_fetch_assoc($adjunct3PPG);

$query_adjunct4 = "SELECT adjunctYield, adjunctLovibond FROM adjuncts WHERE adjunctName='$brewAdjunct4'";
$adjunct4 = mysqli_query($brewing,$query_adjunct4) or die(mysqli_error($brewing));
$row_adjunct4 = mysqli_fetch_assoc($adjunct4);

$query_adjunct4PPG = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_adjunct4['adjunctYield']);
$adjunct4PPG = mysqli_query($brewing,$query_adjunct4PPG) or die(mysqli_error($brewing));
$row_adjunct4PPG = mysqli_fetch_assoc($adjunct4PPG);

$query_adjunct5 = "SELECT adjunctYield, adjunctLovibond FROM adjuncts WHERE id='$brewAdjunct5'";
$adjunct5 = mysqli_query($brewing,$query_adjunct5) or die(mysqli_error($brewing));
$row_adjunct5 = mysqli_fetch_assoc($adjunct5);

$query_adjunct5PPG = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_adjunct5['adjunctYield']);
$adjunct5PPG = mysqli_query($brewing,$query_adjunct5PPG) or die(mysqli_error($brewing));
$row_adjunct5PPG = mysqli_fetch_assoc($adjunct5PPG);

$query_adjunct6 = "SELECT adjunctYield, adjunctLovibond FROM adjuncts WHERE adjunctName='$brewAdjunct6'";
$adjunct6 = mysqli_query($brewing,$query_adjunct6) or die(mysqli_error($brewing));
$row_adjunct6 = mysqli_fetch_assoc($adjunct6);

$query_adjunct6PPG = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_adjunct6['adjunctYield']);
$adjunct6PPG = mysqli_query($brewing,$query_adjunct6PPG) or die(mysqli_error($brewing));
$row_adjunct6PPG = mysqli_fetch_assoc($adjunct6PPG);

$query_adjunct7 = "SELECT adjunctYield, adjunctLovibond FROM adjuncts WHERE adjunctName='$brewAdjunct7'";
$adjunct7 = mysqli_query($brewing,$query_adjunct7) or die(mysqli_error($brewing));
$row_adjunct7 = mysqli_fetch_assoc($adjunct7);

$query_adjunct7PPG = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_adjunct7['adjunctYield']);
$adjunct7PPG = mysqli_query($brewing,$query_adjunct7PPG) or die(mysqli_error($brewing));
$row_adjunct7PPG = mysqli_fetch_assoc($adjunct7PPG);

$query_adjunct8 = "SELECT adjunctYield, adjunctLovibond FROM adjuncts WHERE adjunctName='$brewAdjunct8'";
$adjunct8 = mysqli_query($brewing,$query_adjunct8) or die(mysqli_error($brewing));
$row_adjunct8 = mysqli_fetch_assoc($adjunct8);

$query_adjunct8PPG = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_adjunct8['adjunctYield']);
$adjunct8PPG = mysqli_query($brewing,$query_adjunct8PPG) or die(mysqli_error($brewing));
$row_adjunct8PPG = mysqli_fetch_assoc($adjunct8PPG);

$query_adjunct9 = "SELECT adjunctYield, adjunctLovibond FROM adjuncts WHERE adjunctName='$brewAdjunct9'";
$adjunct9 = mysqli_query($brewing,$query_adjunct9) or die(mysqli_error($brewing));
$row_adjunct9 = mysqli_fetch_assoc($adjunct9);

$query_adjunct9PPG = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_adjunct9['adjunctYield']);
$adjunct9PPG = mysqli_query($brewing,$query_adjunct9PPG) or die(mysqli_error($brewing));
$row_adjunct9PPG = mysqli_fetch_assoc($adjunct9PPG);
...
for($i = 1; $i <= 9; ++$i) {
    ...
    $$hops = mysqli_query($brewing,$$query_hops);
