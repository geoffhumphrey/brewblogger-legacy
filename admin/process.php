...
VALUES 
  ...
  $Result1 = mysqli_query($brewing,$insertSQL) or die(mysqli_error($brewing));
...
if (($action == "edit") && ($dbTable == "brewing")) {
  ...
  mysqli_select_db($brewing,$database_brewing);
  $Result1 = mysqli_query($brewing,$updateSQL) or die(mysqli_error($brewing));
...
if (($action == "update") && (($dbTable == "brewing") || ($dbTable == "recipes"))) {
  ...
  $updateSQL = sprintf("UPDATE $dbTable SET 
	...
	WHERE id='%s'",
		       GetSQLValueString($_POST['brewName'], "scrubbed"),
                       ...
                       GetSQLValueString($_POST['brewGrain9'], "text"),
                       GetSQLValueString($_POST['brewGrain9Weight'], "text"),
                       GetSQLValueString($_POST['brewAdjunct1'], "text"),
                       GetSQLValueString($_POST['brewAdjunct1Weight'], "text"),
                       GetSQLValueString($_POST['brewAdjunct2'], "text"),
                       GetSQLValueString($_POST['brewAdjunct2Weight'], "text"),
                       GetSQLValueString($_POST['brewAdjunct3'], "text"),
                       GetSQLValueString($_POST['brewAdjunct3Weight'], "text"),
                       GetSQLValueString($_POST['brewAdjunct4'], "text"),
                       GetSQLValueString($_POST['brewAdjunct4Weight'], "text"),
                       GetSQLValueString($_POST['brewAdjunct5'], "text"),
                       GetSQLValueString($_POST['brewAdjunct5Weight'], "text"),
                       GetSQLValueString($_POST['brewAdjunct6'], "text"),
                       GetSQLValueString($_POST['brewAdjunct6Weight'], "text"),
                       GetSQLValueString($_POST['brewAdjunct7'], "text"),
                       GetSQLValueString($_POST['brewAdjunct7Weight'], "text"),
                       GetSQLValueString($_POST['brewAdjunct8'], "text"),
                       GetSQLValueString($_POST['brewAdjunct8Weight'], "text"),
                       GetSQLValueString($_POST['brewAdjunct9'], "text"),
                       GetSQLValueString($_POST['brewAdjunct9Weight'], "text"),
                       GetSQLValueString($_POST['brewHops1'], "text"),
                       GetSQLValueString($_POST['brewHops1Weight'], "text"),
                       GetSQLValueString($_POST['brewHops1IBU'], "text"),
                       GetSQLValueString($_POST['brewHops1Time'], "text"),
		       ...
		       GetSQLValueString($_POST['brewHops10IBU'], "text"),
		       GetSQLValueString($_POST['brewHops10Time'], "text"),
		       GetSQLValueString(get_hop_use($_POST['brewHops10Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops10Time']), "text"),
		       GetSQLValueString($_POST['brewHops10Form'], "text"),
		       GetSQLValueString($_POST['brewHops11'], "text"),
		       GetSQLValueString($_POST['brewHops11Weight'], "text"),
		       GetSQLValueString($_POST['brewHops11IBU'], "text"),
		       GetSQLValueString($_POST['brewHops11Time'], "text"),
		       GetSQLValueString(get_hop_use($_POST['brewHops11Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops11Time']), "text"),
		       GetSQLValueString($_POST['brewHops11Form'], "text"),
		       GetSQLValueString($_POST['brewHops12'], "text"),
		       GetSQLValueString($_POST['brewHops12Weight'], "text"),
		       GetSQLValueString($_POST['brewHops12IBU'], "text"),
		       GetSQLValueString($_POST['brewHops12Time'], "text"),
		       GetSQLValueString(get_hop_use($_POST['brewHops12Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops12Time']), "text"),
		       GetSQLValueString($_POST['brewHops12Form'], "text"),
		       GetSQLValueString($_POST['brewHops13'], "text"),
		       GetSQLValueString($_POST['brewHops13Weight'], "text"),
		       GetSQLValueString($_POST['brewHops13IBU'], "text"),
		       GetSQLValueString($_POST['brewHops13Time'], "text"),
		       GetSQLValueString(get_hop_use($_POST['brewHops13Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops13Time']), "text"),
		       GetSQLValueString($_POST['brewHops13Form'], "text"),
		       GetSQLValueString($_POST['brewHops14'], "text"),
		       GetSQLValueString($_POST['brewHops14Weight'], "text"),
		       GetSQLValueString($_POST['brewHops14IBU'], "text"),
		       GetSQLValueString($_POST['brewHops14Time'], "text"),
		       GetSQLValueString(get_hop_use($_POST['brewHops14Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops14Time']), "text"),
		       GetSQLValueString($_POST['brewHops14Form'], "text"),
		       GetSQLValueString($_POST['brewHops15'], "text"),
		       GetSQLValueString($_POST['brewHops15Weight'], "text"),
		       GetSQLValueString($_POST['brewHops15IBU'], "text"),
		       GetSQLValueString($_POST['brewHops15Time'], "text"),
		       GetSQLValueString(get_hop_use($_POST['brewHops15Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops15Time']), "text"),
		       GetSQLValueString($_POST['brewHops15Form'], "text"),
			   GetSQLValueString(get_hop_use($_POST['brewHops1Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops1Time']), "text"),
			   GetSQLValueString(get_hop_use($_POST['brewHops2Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops2Time']), "text"),
			   GetSQLValueString(get_hop_use($_POST['brewHops3Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops3Time']), "text"),
			   GetSQLValueString(get_hop_use($_POST['brewHops4Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops4Time']), "text"),
			   GetSQLValueString(get_hop_use($_POST['brewHops5Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops5Time']), "text"),
			   GetSQLValueString(get_hop_use($_POST['brewHops6Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops6Time']), "text"),
			   GetSQLValueString(get_hop_use($_POST['brewHops7Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops7Time']), "text"),
			   GetSQLValueString(get_hop_use($_POST['brewHops8Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops8Time']), "text"),
			   GetSQLValueString(get_hop_use($_POST['brewHops9Time'],$_POST['brewBoilTime']), "text"),
		       GetSQLValueString(get_hop_type($_POST['brewHops9Time']), "text"),
		       GetSQLValueString($id, "int"));
  ...
  if ($dbTable == "brewing") {
    $updateSQL = sprintf("UPDATE $dbTable SET brewTargetOG=%s, brewTargetFG=%s WHERE id='%s'", 
			 GetSQLValueString($_POST['brewOG'], "text"),
			 GetSQLValueString($_POST['brewFG'], "text"),
			 GetSQLValueString($id, "int"));
  } else {
    $updateSQL = sprintf("UPDATE $dbTable SET brewOG=%s, brewFG=%s WHERE id='%s'", 
			 GetSQLValueString($_POST['brewOG'], "text"),
			 GetSQLValueString($_POST['brewFG'], "text"),
			 GetSQLValueString($id, "int"));
  }
  mysqli_query($brewing,$updateSQL) or die(mysqli_error($brewing));
...
if (($action == "add") && ($dbTable == "awards")) {
	...
	$log = mysqli_query($brewing,$query_log) or die(mysqli_error($brewing));
