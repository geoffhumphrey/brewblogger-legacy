...
function DHTMLgoodies_formTooltip()
{
	...
	this.arrowImageFile = 'yellow-arrow.gif';
	this.arrowImageFileRight = 'yellow-arrow-right.gif';
	this.tooltipWidth = 200;
	this.tooltipBgColor = '#f5e641';
	this.closeMessage = 'Close';
	this.disableTooltipMessage = 'Don\'t show tooltips';
	...
	this.disableTooltipByCookie = true;
