...
<tr>
   ...
   <?php } while ($row_extracts = mysqli_fetch_assoc($extracts)); $rows = mysqli_fetch_assoc($extracts); if($rows > 0) { mysqli_data_seek($extracts, 0); $row_extracts = mysqli_fetch_assoc($extracts); } ?>
   </select>
   </td>
