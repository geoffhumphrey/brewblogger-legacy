...
<tr>
   ...
   <select name="brewYeastProfile">
   	...
   	<?php } while ($row_yeast_profiles = mysqli_fetch_assoc($yeast_profiles)); $rows = mysqli_num_rows($yeast_profiles); if($rows > 0) { mysqli_data_seek($yeast_profiles, 0); $row_yeast_profiles = mysqli_fetch_assoc($yeast_profiles); } ?>
   	</select>
   </td>
</tr>
<tr>
