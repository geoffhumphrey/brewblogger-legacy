...
<tr>
   ...
   <select name="brewHops1" >
    ...
    <?php } while ($row_hops = mysqli_fetch_assoc($hops)); $rows = mysqli_num_rows($hops); if($rows > 0) { mysqli_data_seek($hops, 0); $row_hops = mysqli_fetch_assoc($hops); } ?>
	<option value="Other">Other</option>
   </select>
   </td>
     <td nowrap="nowrap" class="data"><input name="brewHops1Weight" type="text" id="brewHops1Weight" size="5" tooltipText="<?php echo $toolTip_decimal; ?>" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops1Weight']; if ($action == "importCalc") echo $brewHops1Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
    <td nowrap="nowrap" class="data"><input name="brewHops1IBU" type="text" id="brewHops1IBU" size="5" tooltipText="<?php echo $toolTip_decimal; ?>" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops1IBU']; if ($action == "importCalc") echo $brewHops1IBU; ?>">&nbsp;%</td>
    <td nowrap="nowrap" class="data"><input type="text" name="brewHops1Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops1Time'];  if ($action == "importCalc") echo $brewHops1Time; ?>">&nbsp;min.
    </td>
   ...
   <td class="data"><input name="brewHops2Weight" type="text" id="brewHops2Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops2Weight']; if ($action == "importCalc") echo $brewHops2Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
   <td class="data"><input name="brewHops2IBU" type="text" id="brewHops2IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops2IBU']; if ($action == "importCalc") echo $brewHops2IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops2Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops2Time']; if ($action == "importCalc") echo $brewHops2Time; ?>">&nbsp;min.</td>
...
<tr>
   ...
   <select name="brewHops3" >
	...
	<option value="Other">Other</option>
     ...
     <td class="data"><input name="brewHops3Weight" type="text" id="brewHops3Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops3Weight']; if ($action == "importCalc") echo $brewHops3Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
     <td class="data"><input name="brewHops3IBU" type="text" id="brewHops3IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops3IBU']; if ($action == "importCalc") echo $brewHops3IBU; ?>">&nbsp;%</td>
     <td class="data"><input type="text" name="brewHops3Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops3Time']; if ($action == "importCalc") echo $brewHops3Time; ?>">&nbsp;min.</td>
...
<tr>
   ...
   <td class="data"><input name="brewHops4Weight" type="text" id="brewHops4Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops4Weight']; if ($action == "importCalc") echo $brewHops4Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
   <td class="data"><input name="brewHops4IBU" type="text" id="brewHops4IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops4IBU']; if ($action == "importCalc") echo $brewHops4IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops4Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops4Time']; if ($action == "importCalc") echo $brewHops4Time; ?>">&nbsp;min.</td>
...
<tr>
   ...
   <td class="data"><input name="brewHops5Weight" type="text" id="brewHops5Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops5Weight']; if ($action == "importCalc") echo $brewHops5Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
   <td class="data"><input name="brewHops5IBU" type="text" id="brewHops5IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops5IBU']; if ($action == "importCalc") echo $brewHops5IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops5Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops5Time']; if ($action == "importCalc") echo $brewHops5Time; ?>">&nbsp;min.</td>
...
<tr>
   ...
   <td class="data"><input name="brewHops6Weight" type="text" id="brewHops6Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops6Weight']; if ($action == "importCalc") echo $brewHops6Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
   <td class="data"><input name="brewHops6IBU" type="text" id="brewHops6IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops6IBU']; if ($action == "importCalc") echo $brewHops6IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops6Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops6Time']; if ($action == "importCalc") echo $brewHops6Time; ?>">&nbsp;min.</td>
...
<option value="">-- Items below are in the Hops DB --</option>
	...
	<option value="Other">Other</option>
     ...
     <td class="data"><input name="brewHops7Weight" type="text" id="brewHops7Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops7Weight']; if ($action == "importCalc") echo $brewHops7Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
     <td class="data"><input name="brewHops7IBU" type="text" id="brewHops7IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops7IBU']; if ($action == "importCalc") echo $brewHops7IBU; ?>">&nbsp;%</td>
     <td class="data"><input type="text" name="brewHops7Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops7Time']; if ($action == "importCalc") echo $brewHops7Time; ?>">&nbsp;min.</td>
...
<option value="">-- Items below are in the Hops DB --</option>
   ...
   <td class="data"><input name="brewHops8Weight" type="text" id="brewHops8Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops8Weight']; if ($action == "importCalc") echo $brewHops8Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
   <td class="data"><input name="brewHops8IBU" type="text" id="brewHops8IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops8IBU']; if ($action == "importCalc") echo $brewHops8IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops8Time" size="5"  value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops8Time']; if ($action == "importCalc") echo $brewHops8Time; ?>">&nbsp;min.</td>
...
<option value="">-- Items below are in the Hops DB --</option>
   ...
   <td class="data"><input name="brewHops9Weight" type="text" id="brewHops9Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops9Weight']; if ($action == "importCalc") echo $brewHops9Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
   <td class="data"><input name="brewHops9IBU" type="text" id="brewHops9IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops9IBU']; if ($action == "importCalc") echo $brewHops9IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops9Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops9Time']; if ($action == "importCalc") echo $brewHops9Time; ?>">&nbsp;min.</td>
...
<option value="">-- Items below are in the Hops DB --</option>
   ...
   <td class="data"><input name="brewHops10Weight" type="text" id="brewHops10Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops10Weight']; if ($action == "importCalc") echo $brewHops10Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
   <td class="data"><input name="brewHops10IBU" type="text" id="brewHops10IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops10IBU']; if ($action == "importCalc") echo $brewHops10IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops10Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops10Time']; if ($action == "importCalc") echo $brewHops10Time; ?>">&nbsp;min.</td>
...
<option value="">-- Items below are in the Hops DB --</option>
   ...
   <td class="data"><input name="brewHops11Weight" type="text" id="brewHops11Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops11Weight']; if ($action == "importCalc") echo $brewHops11Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
   <td class="data"><input name="brewHops11IBU" type="text" id="brewHops11IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops11IBU']; if ($action == "importCalc") echo $brewHops11IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops11Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops11Time']; if ($action == "importCalc") echo $brewHops11Time; ?>">&nbsp;min.</td>
...
<option value="">-- Items below are in the Hops DB --</option>
   ...
   <td class="data"><input name="brewHops12Weight" type="text" id="brewHops12Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops12Weight']; if ($action == "importCalc") echo $brewHops12Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
   <td class="data"><input name="brewHops12IBU" type="text" id="brewHops12IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops12IBU']; if ($action == "importCalc") echo $brewHops12IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops12Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops12Time']; if ($action == "importCalc") echo $brewHops12Time; ?>">&nbsp;min.</td>
...
<option value="">-- Items below are in the Hops DB --</option>
   ...
   <td class="data"><input name="brewHops13Weight" type="text" id="brewHops13Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops13Weight']; if ($action == "importCalc") echo $brewHops13Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
   <td class="data"><input name="brewHops13IBU" type="text" id="brewHops13IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops13IBU']; if ($action == "importCalc") echo $brewHops13IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops13Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops13Time']; if ($action == "importCalc") echo $brewHops13Time; ?>">&nbsp;min.</td>
...
<option value="">-- Items below are in the Hops DB --</option>
   ...
   <td class="data"><input name="brewHops14Weight" type="text" id="brewHops14Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops14Weight']; if ($action == "importCalc") echo $brewHops14Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
   <td class="data"><input name="brewHops14IBU" type="text" id="brewHops14IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops14IBU']; if ($action == "importCalc") echo $brewHops14IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops14Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops14Time']; if ($action == "importCalc") echo $brewHops14Time; ?>">&nbsp;min.</td>
...
<option value="">-- Items below are in the Hops DB --</option>
   ...
   <td class="data"><input name="brewHops15Weight" type="text" id="brewHops15Weight" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops15Weight']; if ($action == "importCalc") echo $brewHops15Weight; ?>">&nbsp;<?php if ($row_pref['measWeight1'] == "ounces") echo "oz."; if ($row_pref['measWeight1'] == "grams") echo "g."  ?></td>
   <td class="data"><input name="brewHops15IBU" type="text" id="brewHops15IBU" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops15IBU']; if ($action == "importCalc") echo $brewHops15IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops15Time" size="5" value="<?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) echo $row_log['brewHops15Time']; if ($action == "importCalc") echo $brewHops15Time; ?>">&nbsp;min.</td>
