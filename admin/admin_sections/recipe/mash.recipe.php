...
<tr>
    ...
    <?php } while ($row_mash_profiles = mysqli_fetch_assoc($mash_profiles)); $rows = mysqli_num_rows($mash_profiles);	if($rows > 0) {	mysqli_data_seek($mash_profiles, 0); $row_mash_profiles = mysqli_fetch_assoc($mash_profiles); } ?>
   </select>
   </td>
</tr>
<tr> 
