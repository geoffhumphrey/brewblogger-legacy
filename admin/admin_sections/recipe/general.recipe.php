...
<tr>
   ...
   <select name="brewStyle">
    <?php do {  ?>
     <option value="<?php echo $row_styles['brewStyle']?>" <?php if (($action == "edit") || ($action=="import") || ($action == "importRecipe") || ($action=="reuse")) {  if (!(strcmp($row_styles['brewStyle'], $row_log['brewStyle']))) {echo "SELECTED";} } if ($action == "importCalc") {  if ($row_styles['brewStyle'] == $brewStyle ) echo "SELECTED"; } ?>><?php echo $row_styles['brewStyleGroup'].$row_styles['brewStyleNum']." - ".$row_styles['brewStyle']?></option>
