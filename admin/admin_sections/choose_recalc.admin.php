...
<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
	...
	<?php } while ($row_brewBlogs = mysqli_fetch_assoc($brewBlogs)); $rows = mysqli_num_rows($brewBlogs);	if($rows > 0) {	mysqli_data_seek($brewBlogs, 0); $row_brewBlogs = mysqli_fetch_assoc($brewBlogs); } ?>
  </select>
  </form>
</td>
</tr>
...
<select name="menu2" onChange="MM_jumpMenu('parent',this,0)">
	...
	<?php } while ($row_recipes = mysqli_fetch_assoc($recipes)); $rows = mysqli_num_rows($recipes);	if($rows > 0) {	mysqli_data_seek($recipes, 0); $row_recipes = mysqli_fetch_assoc($recipes); } ?>
  </select>
  </form>
</td>
</tr>
