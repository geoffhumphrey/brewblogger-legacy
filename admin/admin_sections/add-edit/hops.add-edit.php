...
<tr>
    ...
    <td class="data"><input type="text" name="hopsAAULow" tooltipText="<?php echo $toolTip_decimal; ?>" value="<?php if ($action == "edit") echo $row_log['hopsAAULow']; ?>" size="15"></td>
</tr>
<tr>
    <td class="dataLabelLeft">AAU High:</td>
    <td class="data"><input type="text" name="hopsAAUHigh" tooltipText="<?php echo $toolTip_decimal; ?>" value="<?php if ($action == "edit") echo $row_log['hopsAAUHigh']; ?>" size="15"></td>
</tr>
<tr>
