...
<tr <?php echo " style=\"background-color:$color\"";?>>
   ...
   <td class="data_icon_list"><a href="index.php?action=reuse&dbTable=yeast_profiles&id=<?php echo $row_yeast_profiles['id']; ?>"><img src="<?php echo $imageSrc; ?>page_refresh.png" align="absmiddle" border="0" alt="Copy the <?php echo $row_yeast_profiles['yeastName']; ?> Yeast Profile" title="Copy the <?php echo $row_yeast_profiles['yeastName']; ?> Yeast Profile"></a></td>
   ...
   <td class="data_icon_list"><a href="index.php?action=edit&dbTable=yeast_profiles&id=<?php echo $row_yeast_profiles['id']; ?>"><img src="<?php echo $imageSrc; ?>pencil.png" align="absmiddle" border="0" alt="Edit <?php echo $row_yeast_profiles['yeastName']; ?>" title="Edit <?php echo $row_yeast_profiles['yeastName']; ?>"></a></td>
