...
<tr <?php echo " style=\"background-color:$color\"";?>>
    ...
    <td class="data_icon_list"><?php if (($row_user['user_name'] == $row_users['user_name']) && ($row_user['userLevel'] == "2")) echo "Change your password: "; ?><a href="index.php?action=edit&dbTable=users&section=password&filter=<?php echo $row_users['user_name']; ?>&id=<?php echo $row_users['id']; ?>"><img src="<?php echo $imageSrc; ?>key.png" align="absmiddle" border="0" alt="Edit <?php echo $row_users['user_name']; ?>'s Password"  title="Edit <?php echo $row_users['user_name']; ?>'s Password"></a></td>
	<td class="data_icon_list"><a href="index.php?action=edit&dbTable=users&filter=<?php echo $row_users['user_name']; ?>&id=<?php echo $row_users['id']; ?>"><img src="<?php echo $imageSrc; ?>pencil.png" align="absmiddle" border="0" alt="Edit <?php echo $row_users['user_name']; ?>" title="Edit <?php echo $row_users['user_name']; ?>"></a></td>
