...
$style1 = mysqli_query($brewing,$query_style1) or die(mysqli_error($brewing));
$row_style1 = mysqli_fetch_assoc($style1);
$totalRows_style1 = mysqli_num_rows($style1);

$query_style2 = "SELECT * FROM styles";
$style2 = mysqli_query($brewing,$query_style2) or die(mysqli_error($brewing));
$row_style2 = mysqli_fetch_assoc($style2);
$totalRows_style2 = mysqli_num_rows($style2);

$query_brewer = sprintf("SELECT * FROM users WHERE user_name = '%s'", $filter);
$brewer = mysqli_query($brewing,$query_brewer) or die(mysqli_error($brewing));
$row_brewer = mysqli_fetch_assoc($brewer);
$totalRows_brewer = mysqli_num_rows($brewer);

$query_club = "SELECT * FROM brewer WHERE id = '1'";
$club = mysqli_query($brewing,$query_club) or die(mysqli_error($brewing));
...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
  ...
  <tr>
    ...
    <select name="style">
      ...
      <?php } while ($row_style2 = mysqli_fetch_assoc($style2)); ?>
    </select>	
