...
$sugarPPG1 = mysqli_query($brewing,$query_sugarPPG1) or die(mysqli_error($brewing));
$row_sugarPPG1 = mysqli_fetch_assoc($sugarPPG1);

$query_sugarPPG2 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt2['maltYield']);
$sugarPPG2 = mysqli_query($brewing,$query_sugarPPG2) or die(mysqli_error($brewing));
$row_sugarPPG2 = mysqli_fetch_assoc($sugarPPG2);

$query_sugarPPG3 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt3['maltYield']);
$sugarPPG3 = mysqli_query($brewing,$query_sugarPPG3) or die(mysqli_error($brewing));
$row_sugarPPG3 = mysqli_fetch_assoc($sugarPPG1);

$query_sugarPPG4 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt4['maltYield']);
$sugarPPG4 = mysqli_query($brewing,$query_sugarPPG4) or die(mysqli_error($brewing));
$row_sugarPPG4 = mysqli_fetch_assoc($sugarPPG4);

$query_sugarPPG5 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt5['maltYield']);
$sugarPPG5 = mysqli_query($brewing,$query_sugarPPG5) or die(mysqli_error($brewing));
$row_sugarPPG5 = mysqli_fetch_assoc($sugarPPG5);

$query_sugarPPG6 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt6['maltYield']);
$sugarPPG6 = mysqli_query($brewing,$query_sugarPPG6) or die(mysqli_error($brewing));
$row_sugarPPG6 = mysqli_fetch_assoc($sugarPPG6);

$query_sugarPPG7 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt7['maltYield']);
$sugarPPG7 = mysqli_query($brewing,$query_sugarPPG7) or die(mysqli_error($brewing));
$row_sugarPPG7 = mysqli_fetch_assoc($sugarPPG7);

$query_sugarPPG8 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt8['maltYield']);
$sugarPPG8 = mysqli_query($brewing,$query_sugarPPG8) or die(mysqli_error($brewing));
$row_sugarPPG8 = mysqli_fetch_assoc($sugarPPG8);

$query_sugarPPG9 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt9['maltYield']);
$sugarPPG9 = mysqli_query($brewing,$query_sugarPPG9) or die(mysqli_error($brewing));
$row_sugarPPG9 = mysqli_fetch_assoc($sugarPPG9);

$query_sugarPPG10 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt10['maltYield']);
$sugarPPG10 = mysqli_query($brewing,$query_sugarPPG10) or die(mysqli_error($brewing));
$row_sugarPPG10 = mysqli_fetch_assoc($sugarPPG10);

$query_sugarPPG11 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt11['maltYield']);
$sugarPPG11 = mysqli_query($brewing,$query_sugarPPG11) or die(mysqli_error($brewing));
$row_sugarPPG11 = mysqli_fetch_assoc($sugarPPG11);

$query_sugarPPG12 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt12['maltYield']);
$sugarPPG12 = mysqli_query($brewing,$query_sugarPPG12) or die(mysqli_error($brewing));
$row_sugarPPG12 = mysqli_fetch_assoc($sugarPPG12);

$query_sugarPPG13 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt13['maltYield']);
$sugarPPG13 = mysqli_query($brewing,$query_sugarPPG13) or die(mysqli_error($brewing));
$row_sugarPPG13 = mysqli_fetch_assoc($sugarPPG13);

$query_sugarPPG14 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt14['maltYield']);
$sugarPPG14 = mysqli_query($brewing,$query_sugarPPG14) or die(mysqli_error($brewing));
$row_sugarPPG14 = mysqli_fetch_assoc($sugarPPG14);

$query_sugarPPG15 = sprintf("SELECT sugarPPG FROM sugar_type WHERE id='%s'", $row_malt15['maltYield']);
$sugarPPG15 = mysqli_query($brewing,$query_sugarPPG15) or die(mysqli_error($brewing));
$row_sugarPPG15 = mysqli_fetch_assoc($sugarPPG15);
