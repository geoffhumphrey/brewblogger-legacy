...
class InputBeerXML {
    ...
    function insertRecipe($recipe){
        ...
        $brewing = new mysqli($GLOBALS['hostname_brewblog'], $GLOBALS['username_brewblog'], $GLOBALS['password_brewblog'], $GLOBALS['database_brewing'], $GLOBALS['database_port']) or trigger_error(mysqli_error($brewing));
        ...
        //echo $sqlQuery . "<br />";
        mysqli_select_db($brewing,$database_brewing) or die(mysqli_error($brewing));
    ...
    function insertBlog($recipe){
        ...
        $vf["brewStyle"] = $recipe->style->name;
        //$vf["brewSource"] = "BeerXML Parser";
        //$vf["brewBatchNum"] = ((int)mysqli_query($brewing,$batchNumber))++;
        $vf["brewYield"] = round(($recipe->batchSize * 0.26418), 3);
