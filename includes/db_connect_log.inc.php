...
$news = mysqli_query($brewing,$query_news) or die(mysqli_error($brewing));
...
mysqli_select_db($brewing,$database_brewing);
$query_result = "SELECT COUNT(*) as 'count' FROM brewing";
if ($style != "all") $query_result .= " WHERE brewStyle='$style' AND"; else $query_result .= " WHERE";
$query_result .= " NOT brewArchive='Y'";
$result = mysqli_query($brewing,$query_result) or die(mysqli_error($brewing));
$row_result =  mysqli_fetch_assoc($result);
$total = $row_result['count'];
...
if (($row_pref['mode'] == "2") && ($filter != "all")) {
mysqli_select_db($brewing,$database_brewing);
$query_result = "SELECT COUNT(*) as 'count' FROM brewing WHERE brewBrewerID='$filter'";
...
if ($row_pref['mode'] == "1") {
mysqli_select_db($brewing,$database_brewing);
$result = mysqli_query($brewing,"SELECT COUNT(*) as 'count' FROM brewing");
$total = $row_result['count'];
$list = mysqli_query($brewing,"SELECT * FROM brewing WHERE brewArchive='' OR brewArchive='N' ORDER BY brewDate DESC LIMIT $start, $display");
...
if (($row_pref['mode'] == "2") && ($filter != "all")) {
mysqli_select_db($brewing,$database_brewing);
$result = mysqli_query($brewing,"SELECT COUNT(*) as 'count' FROM brewing WHERE brewBrewerID = '$filter'");
$row_result =  mysqli_fetch_assoc($result);
$total = $row_result['count'];
$list = mysqli_query($brewing,"SELECT * FROM brewing WHERE brewArchive='' OR brewArchive='N' AND brewBrewerID = '$filter'ORDER BY brewDate DESC LIMIT $start, $display") or die(mysqli_error($brewing));
$row_list = mysqli_fetch_assoc($list);
}

if ($page == "about") {
mysqli_select_db($brewing,$database_brewing);
$result = mysqli_query($brewing,"SELECT COUNT(*) as 'count' FROM brewerlinks");
$row_result =  mysqli_fetch_assoc($result);
$total = $row_result['count'];
$list = mysqli_query($brewing,"SELECT * FROM brewerlinks ORDER BY brewerLinkName ASC LIMIT $start, $display");
$row_list = mysqli_fetch_assoc($list);
}
...
$review = mysqli_query($brewing,$query_limit_review) or die(mysqli_error($brewing));
} else
$review = mysqli_query($brewing,$query_review) or die(mysqli_error($brewing));
$row_review = mysqli_fetch_assoc($review);

if (isset($_GET['totalRows_review'])) {
  $totalRows_review = $_GET['totalRows_review'];
} else {
  $all_review = mysqli_query($brewing,$query_review);
...
mysqli_select_db($brewing,$database_brewing);
$query_result = "SELECT COUNT(*) as 'count' FROM recipes";
if ($style != "all") $query_result .= " WHERE brewStyle='$style' AND"; else $query_result .= " WHERE";
$query_result .= " NOT brewArchive='Y'";
$result = mysqli_query($brewing,$query_result) or die(mysqli_error($brewing));
$row_result =  mysqli_fetch_assoc($result);
$total = $row_result['count'];
//$recipeList = mysqli_query($brewing,"SELECT * FROM recipes ORDER BY $sort $dir LIMIT $start, $display") or die(mysqli_error($brewing));
...
$recipeList = mysqli_query($brewing,$query_recipeList) or die(mysqli_error($brewing));
...
if (($row_pref['mode'] == "2") && ($filter != "all")) {
mysqli_select_db($brewing,$database_brewing);
$query_result = "SELECT COUNT(*) as 'count' FROM recipes WHERE brewBrewerID='$filter'";
if ($style != "all") $query_result .= " AND brewStyle='$style'";
$query_result .= " AND NOT brewArchive='Y'";
$result = mysqli_query($brewing,$query_result) or die(mysqli_error($brewing));
$row_result =  mysqli_fetch_assoc($result);
...
mysqli_select_db($brewing,$database_brewing);
$result = mysqli_query($brewing,"SELECT COUNT(*) as 'count' FROM recipes");
$row_result =  mysqli_fetch_assoc($result);
$total = $row_result['count'];
$list = mysqli_query($brewing,"SELECT * FROM recipes ORDER BY brewName ASC LIMIT $start, $display");
$row_list = mysqli_fetch_assoc($list);
}
...
/* paginating from a database */
mysqli_select_db($brewing,$database_brewing);
$result = mysqli_query($brewing,"SELECT COUNT(*) as 'count' FROM recipes WHERE brewBrewerID = '".$filter."'");
$row_result =  mysqli_fetch_assoc($result);
$total = $row_result['count'];
$list = mysqli_query($brewing,"SELECT * FROM recipes WHERE brewBrewerID = '".$filter."' ORDER BY brewName ASC LIMIT $start, $display");
$row_list = mysqli_fetch_assoc($list);
}
...
if ($row_pref['mode'] == "1") {
mysqli_select_db($brewing,$database_brewing);
$result = mysqli_query($brewing,"SELECT COUNT(*) as 'count' FROM awards");
$row_result =  mysqli_fetch_assoc($result);
$total = $row_result['count'];
$awardsList = mysqli_query($brewing,"SELECT * FROM awards ORDER BY $sort $dir LIMIT $start, $display") or die(mysqli_error($brewing));
...
if (($row_pref['mode'] == "2") && ($filter != "all")) {
mysqli_select_db($brewing,$database_brewing);
$result = mysqli_query($brewing,"SELECT COUNT(*) as 'count' FROM awards WHERE brewBrewerID = '".$filter."'");
$row_result =  mysqli_fetch_assoc($result);
$total = $row_result['count'];
$awardsList = mysqli_query($brewing,"SELECT * FROM awards WHERE brewBrewerID = '".$filter."' ORDER BY $sort $dir LIMIT $start, $display") or die(mysqli_error($brewing));
$row_awardsList = mysqli_fetch_assoc($awardsList);
}
...
$awards = mysqli_query($brewing,$query_awards) or die(mysqli_error($brewing));
...
$user3 = mysqli_query($brewing,$query_user3) or die(mysqli_error($brewing));
...
$members = mysqli_query($brewing,$query_members) or die(mysqli_error($brewing));
...
$query_count = mysqli_query($brewing,$countStatus) or die(mysqli_error($brewing));
...
$status = mysqli_query($brewing,$query_status) or die(mysqli_error($brewing));
...
$query_countUp = mysqli_query($brewing,$countUp) or die(mysqli_error($brewing));
...
$upcoming = mysqli_query($brewing,$query_upcoming) or die(mysqli_error($brewing));
...
$mash_profiles = mysqli_query($brewing,$query_mash_profiles) or die(mysqli_error($brewing));
...
$mash_steps = mysqli_query($brewing,$query_mash_steps) or die(mysqli_error($brewing));
...
$water_profiles = mysqli_query($brewing,$query_water_profiles) or die(mysqli_error($brewing));
...
$equip_profiles = mysqli_query($brewing,$query_equip_profiles) or die(mysqli_error($brewing));
...
// echo $query_featured;
$featured = mysqli_query($brewing,$query_featured) or die(mysqli_error($brewing));
