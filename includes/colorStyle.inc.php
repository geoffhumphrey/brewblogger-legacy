...
if ($colorSRMmin >= 1 && $colorSRMmin < 2) { $beercolorMin ="#f3f993"; }
elseif ($colorSRMmin >= 2 && $colorSRMmin < 3) { $beercolorMin ="#f5f75c"; }
elseif ($colorSRMmin >= 3 && $colorSRMmin < 4) { $beercolorMin ="#f6f513"; }
elseif ($colorSRMmin >= 4 && $colorSRMmin < 5) { $beercolorMin ="#eae615"; }
elseif ($colorSRMmin >= 5 && $colorSRMmin < 6) { $beercolorMin ="#e0d01b"; }
elseif ($colorSRMmin >= 6 && $colorSRMmin < 7) { $beercolorMin ="#d5bc26"; }
elseif ($colorSRMmin >= 7 && $colorSRMmin < 8) { $beercolorMin ="#cdaa37"; }
elseif ($colorSRMmin >= 8 && $colorSRMmin < 9) { $beercolorMin ="#c1963c"; }
elseif ($colorSRMmin >= 9 && $colorSRMmin < 10) { $beercolorMin ="#be8c3a"; }
...
if ($colorSRMmax >= 1 && $colorSRMmax < 2) { $beercolorMax ="#f3f993"; }
elseif ($colorSRMmax >= 2 && $colorSRMmax < 3) { $beercolorMax ="#f5f75c"; }
elseif ($colorSRMmax >= 3 && $colorSRMmax < 4) { $beercolorMax ="#f6f513"; }
elseif ($colorSRMmax >= 4 && $colorSRMmax < 5) { $beercolorMax ="#eae615"; }
elseif ($colorSRMmax >= 5 && $colorSRMmax < 6) { $beercolorMax ="#e0d01b"; }
elseif ($colorSRMmax >= 6 && $colorSRMmax < 7) { $beercolorMax ="#d5bc26"; }
elseif ($colorSRMmax >= 7 && $colorSRMmax < 8) { $beercolorMax ="#cdaa37"; }
elseif ($colorSRMmax >= 8 && $colorSRMmax < 9) { $beercolorMax ="#c1963c"; }
elseif ($colorSRMmax >= 9 && $colorSRMmax < 10) { $beercolorMax ="#be8c3a"; }
