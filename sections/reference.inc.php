...
$yeast = mysqli_query($brewing,$query_yeast) or die(mysqli_error($brewing));
...
<?php do { if ($source == "reference") include ('reference/styles.inc.php'); else include ('../reference/styles.inc.php'); } while ($row_styles = mysqli_fetch_assoc($styles)); ?>
</div>
<?php } ?>
...
<div id="wideWrapperReference">
<?php do { if ($source == "reference") include ('reference/hops.inc.php'); else include ('../reference/hops.inc.php'); } while ($row_styles = mysqli_fetch_assoc($styles)); ?>
</div>	
...
<div id="wideWrapperReference">
<?php do { if ($source == "reference") include ('reference/grains.inc.php'); else include ('../reference/grains.inc.php'); } while ($row_grains = mysqli_fetch_assoc($grains)); ?>
</div>		
<?php } ?>
...
<div id="wideWrapperReference">
<?php do { if ($source == "reference") include ('reference/yeast.inc.php'); else include ('../reference/yeast.inc.php'); } while ($row_yeast = mysqli_fetch_assoc($yeast)); ?>
</div>		
<?php } ?>
<?php 
if ($source == "reference") {
