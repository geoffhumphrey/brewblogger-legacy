<?php   /*
		...
		$styles_filter = mysqli_query($brewing,$query_styles_filter) or die(mysqli_error($brewing));
		$row_styles_filter = mysqli_fetch_assoc($styles_filter);
		$totalRows_styles_filter = mysqli_num_rows($styles_filter);
		*/
		?>
		<div id="contentWide">
        <?php 
        ...
        <table class="dataTable">
			...
			$awards2 = mysqli_query($brewing,$query_awards2) or die(mysqli_error($brewing));
